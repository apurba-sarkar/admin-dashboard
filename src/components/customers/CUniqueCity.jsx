...
const CUniqueCity = ({allCustomers}) => {
    ...
    const uniqueObjects = Array.from(
      // eslint-disable-next-line react/prop-types
      new Set(allCustomers.map((obj) => obj.City))
    ).map((Category) => {
      // eslint-disable-next-line react/prop-types
      return allCustomers.find((obj) => obj.Category === Category);
    });
  ...
  return (
    ...
    <span className="topic-boxmodel"> Total City</span>
